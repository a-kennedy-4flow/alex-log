...
*ASD-STE100 Issue 9 (2025-01-15), part 1 - Writing rules, Section 1 – Words, page 1-1-11*
...
Words that can be technical nouns and technical verbs In some contexts, the same word can be a technical noun and a technical verb. This condition occurs when you can put this word in a technical noun category (rule 1.5) and in a technical verb category (rule 1.12).
