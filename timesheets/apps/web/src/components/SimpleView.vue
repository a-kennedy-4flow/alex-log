...
import type { Allocation } from '@timesheets/core'
import { distribute, halvesPerAllocation, percentTotal } from '@timesheets/core'
import {
  calendar,
  halfDays,
  profile,
...
<template>
  <section class="card" data-tour="quickRows">
